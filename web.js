...
(function() {
  var Player, app, express, http, init, io, onClientDisconnect, onMovePlayer, onNewPlayer, onSocketConnection, path, playerById, players, routes, setEventHandlers, socket, user, util;
